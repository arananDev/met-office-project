...
def get_srs_files(tstart, tend, savedir='./'):
	...
	#file_pattern_swpc = ("ftp://ftp.swpc.noaa.gov/pub/warehouse/")
...
tstart, tend = "1996-01-02", "2020-12-31"
savedir ='C:/Users/user/Documents/Bath University/msc-solarflares-project/Data/data_import/'
csv_filename = 'SRS_all_ar.csv'
